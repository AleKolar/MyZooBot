...
Мне очень жаль(Заказчику, конечно так не скажешь), но это только потому, что я работу работаю времязабирающую. И надо как-то запустить Docker! Спасибо, что дочитали!
